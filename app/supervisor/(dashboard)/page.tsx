        ...
        <>
          ...
          {pendingReg > 0 && (
            <div className="card p-4 mb-6 flex items-center justify-between gap-4 flex-wrap">
              ...
              <Link href="/supervisor/students?registrationStatus=pending" className="btn btn-secondary text-sm">
                مراجعة الطلبات
              </Link>
            </div>
          )}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
            <div className="card p-6 lg:col-span-2">
              <div className="flex items-center justify-between mb-4">
                ...
                <Link href="/supervisor/students" className="text-sm font-semibold" style={{ color: 'var(--accent-deep)' }}>
                  عرض الكل ←
                </Link>
              </div>
              {recent.length === 0 ? (
