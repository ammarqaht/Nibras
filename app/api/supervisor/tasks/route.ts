...
export async function POST(req: NextRequest) {
  try {
    ...
    const { title, description, maxPoints, dueDate, track, stage, submissionMethod, timeLimitHours, lateAfterHours, assignedAdmins, imageUrl, resourceLink, visibility, visibleToIds, cost } = body;
