...
const PROMPT =
  'هذه صورة فاتورة/إيصال شراء. استخرج المنتجات بدقة شديدة بحيث يحتوي كل منتج على (الاسم، الكمية، سعر الوحدة). ' +
  'تأكد من كتابة اسم المنتج بشكل واضح ومقروء باللغة العربية أو الإنجليزية كما هو في الفاتورة (لا تتركه فارغاً إذا كان هناك سعر). ' +
  'الأسعار يجب أن تكون أرقاماً فقط بدون رموز عملات. إذا لم تجد قيمة معينة اتركها فارغة. أعطِ النتيجة بصيغة JSON فقط.';
