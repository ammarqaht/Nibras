...
export default async function LandingPage() {
  ...
  return (
    <main className="min-h-screen flex flex-col overflow-x-hidden">
      ...
      {/* ============================ MARQUEE ============================ */}
      <div className="border-y border-ink-200/70 bg-cream-50 py-4 overflow-hidden">
        <div className="flex items-center gap-10 whitespace-nowrap animate-[marquee_22s_linear_infinite] [--gap:2.5rem]">
