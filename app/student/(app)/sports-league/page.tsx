...
export default function StudentSportsLeague() {
  ...
  if (!league) return (
    <div className="max-w-2xl mx-auto px-4 py-16 text-center">
      ...
      <h1 className="text-2xl font-bold mb-3" style={{color:'var(--ink)'}}>الدوري الرياضي</h1>
      <p style={{color:'var(--ink-soft)'}}>لم يُنشأ الدوري لمرحلتك بعد. تابع المستجدات!</p>
    </div>
  );
  ...
  const sc = STATUS_COLORS[league.status]||STATUS_COLORS.setup;
      ...
      <div className="rounded-2xl p-5 text-white" style={{background:'linear-gradient(135deg,#059669 0%,#047857 100%)'}}>
        <div className="flex items-start justify-between gap-3">
          <div>
            ...
            <p className="text-sm opacity-80 mt-1">فوز {league.winPoints} · تعادل {league.drawPoints}</p>
          </div>
